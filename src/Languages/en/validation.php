...
return [
	...
	'maxSize' => 'The file size in the {field} field has exceeded the maximum allowed.',
	'ext' => 'The file in the {field} field does not have an accepted extension.',
	'mimes' => 'The file in the {field} field does not have an accepted MIME type.',
	'image' => 'The file in the {field} field must be an image.',
	'maxDim' => 'The image in the {field} field exceeds the maximum dimensions.',
	'minDim' => 'The image in the {field} field does not have the minimum dimensions.',
	'dim' => 'The image in the {field} field does not have the required dimensions.',
];
